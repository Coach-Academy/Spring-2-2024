...
signed main() {
	khaled
	// given number x find x ^ 1/3
	double x;cin>>x;// x is positive
	// your solution is correct if it matches my solution upto 6 digits after decimal point
	...
	cout<<fixed<<showpoint<<setprecision(15)<<res<<line;
